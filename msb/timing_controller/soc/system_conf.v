...
`define LM8CFG_PROM_INIT_FILE "C:/Users/AndrewPC1/Documents/GitHub/CoreCam_Firmware/software/timing_controller/prom_init.mem"
`define LM8CFG_PROM_INIT_FILE_FORMAT "hex"
`define SP_ADDRESS_LOCK
`define SP_PORT_TYPE "Memory"
`define LM8SP_PORT_ENABLE
`define LM8CFG_SP_INIT_FILE "C:/Users/AndrewPC1/Documents/GitHub/CoreCam_Firmware/software/timing_controller/scratchpad_init.mem"
...
`define timing_controllerS_WB_DAT_WIDTH 8
`define S_WB_SEL_WIDTH 4
`define timing_controllerS_WB_ADR_WIDTH 32
`endif // SYSTEM_CONF
