...
, uartSIN
, uartSOUT
, timing_controllerclk
, timing_controllerrst
, timing_controllerslv_adr
, timing_controllerslv_master_data
, timing_controllerslv_slave_data
, timing_controllerslv_strb
, timing_controllerslv_cyc
, timing_controllerslv_ack
, timing_controllerslv_err
, timing_controllerslv_rty
, timing_controllerslv_sel
, timing_controllerslv_we
, timing_controllerslv_bte
, timing_controllerslv_cti
, timing_controllerslv_lock
, timing_controllerintr_active_high
);
input	clk_i, reset_n;
genvar i;
...
wire [7:0] timing_controllerS_DAT_O;
wire   timing_controllerS_ACK_O;
wire   timing_controllerS_ERR_O;
wire   timing_controllerS_RTY_O;
wire timing_controllerS_en;
wire timing_controllerINTR_O;
output  timing_controllerclk;
output  timing_controllerrst;
output [32-1:0] timing_controllerslv_adr;
output [8-1:0] timing_controllerslv_master_data;
input [8-1:0] timing_controllerslv_slave_data;
output  timing_controllerslv_strb;
output  timing_controllerslv_cyc;
input  timing_controllerslv_ack;
input  timing_controllerslv_err;
input  timing_controllerslv_rty;
output [3:0]  timing_controllerslv_sel;
output  timing_controllerslv_we;
output [1:0]  timing_controllerslv_bte;
output [2:0]  timing_controllerslv_cti;
output  timing_controllerslv_lock;
input  timing_controllerintr_active_high;
reg [2:0] counter;
...
.CFG_CALL_STACK_32(0),
.CFG_PROM_SIZE(1024),
.CFG_PROM_INIT_FILE("C:/Users/AndrewPC1/Documents/GitHub/CoreCam_Firmware/software/timing_controller/prom_init.mem"),
.CFG_PROM_INIT_FILE_FORMAT("hex"),
.SP_BASE_ADDRESS(32'h0),
.SP_SIZE(1024),
.SP_PORT_ENABLE(1),
.CFG_SP_INIT_FILE("C:/Users/AndrewPC1/Documents/GitHub/CoreCam_Firmware/software/timing_controller/scratchpad_init.mem"),
...
wire [7:0] timing_controllerS_DAT_I;
assign timing_controllerS_DAT_I = SHAREDBUS_DAT_I[7:0];
wire [0:0] timing_controllerS_SEL_I;
assign timing_controllerS_SEL_I = SHAREDBUS_SEL_I;
assign timing_controllerS_en = (SHAREDBUS_ADR_I[31:8] == 24'b100000000000000000000001);
slave_passthru 
#(
.S_WB_DAT_WIDTH(8),
.S_WB_ADR_WIDTH(32))
...
.S_DAT_I(timing_controllerS_DAT_I[7:0]),
.S_DAT_O(timing_controllerS_DAT_O[7:0]),
.S_SEL_I(timing_controllerS_SEL_I),
.S_WE_I(SHAREDBUS_WE_I),
.S_ACK_O(timing_controllerS_ACK_O),
.S_ERR_O(timing_controllerS_ERR_O),
.S_RTY_O(timing_controllerS_RTY_O),
.S_CTI_I(SHAREDBUS_CTI_I),
.S_BTE_I(SHAREDBUS_BTE_I),
.S_LOCK_I(SHAREDBUS_LOCK_I),
.S_CYC_I(SHAREDBUS_CYC_I & timing_controllerS_en),
.S_STB_I(SHAREDBUS_STB_I & timing_controllerS_en),
.clk(timing_controllerclk),
.rst(timing_controllerrst),
.slv_adr(timing_controllerslv_adr),
.slv_master_data(timing_controllerslv_master_data),
.slv_slave_data(timing_controllerslv_slave_data),
.slv_strb(timing_controllerslv_strb),
.slv_cyc(timing_controllerslv_cyc),
.slv_ack(timing_controllerslv_ack),
.slv_err(timing_controllerslv_err),
.slv_rty(timing_controllerslv_rty),
.slv_sel(timing_controllerslv_sel),
.slv_we(timing_controllerslv_we),
.slv_bte(timing_controllerslv_bte),
.slv_cti(timing_controllerslv_cti),
.slv_lock(timing_controllerslv_lock),
.intr_active_high(timing_controllerintr_active_high),
.INTR_O(timing_controllerINTR_O),
.CLK_I(clk_i), .RST_I(sys_reset));


assign LM8interrupts[0] = uartINTR ;
assign LM8interrupts[1] = timing_controllerINTR_O ;
