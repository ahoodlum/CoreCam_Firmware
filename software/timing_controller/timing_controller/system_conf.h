...
#define PLATFORM_NAME         "timing_controller"
#define USE_PLL               (0)
...
/*
 * timing_controller component configuration
 */
#define TIMING_CONTROLLER_NAME  "timing_controller"
#define TIMING_CONTROLLER_BASE_ADDRESS  (0x80000100)
#define TIMING_CONTROLLER_SIZE  (256)
#define TIMING_CONTROLLER_IRQ (1)
#define TIMING_CONTROLLER_CHARIO_IN        (0)
#define TIMING_CONTROLLER_CHARIO_OUT       (0)
#define TIMING_CONTROLLER_ADDRESS_LOCK  (0)
#define TIMING_CONTROLLER_DISABLE  (0)
#define TIMING_CONTROLLER_WB_DAT_WIDTH  (8)
#define TIMING_CONTROLLER_WB_SEL_WIDTH  (4)
#define TIMING_CONTROLLER_WB_ADR_WIDTH  (32)
